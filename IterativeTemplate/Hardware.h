...
public:
	...
	static SpeedController *CollectorSpin;//Right speed controller for collecting
	static SpeedController *CollectorRaise;//Right speed controller for collecting
	...
	static AnalogChannel *collectPot;//Potentiometer for measuring collecting
